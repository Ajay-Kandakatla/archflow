...
export function Topbar({
  ...
  onShowAdmin, onToggleUserMenu, userMenuOpen,
}: TopbarProps) {
    ...
    <div className="topbar">
      <div className="topbar-left">
        ...
        {editingName ? (
          ...
          <span className="diagram-name-display" id="diagramName" onClick={() => setEditingName(true)} title="Click to rename">
            {diagramName}
          </span>
        )}
      </div>
      ...
      <div className="topbar-right">
        ...
        <button className="action-btn btn-export" onClick={onExport}>Export</button>
        ...
        <div id="authArea">
          {currentUser ? (
            ...
            <div id="googleSignInButtonHeader" />
          )}
        </div>
